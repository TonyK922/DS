...
![](DataStructure2.assets/1676183478988.png)
...
![](DataStructure2.assets/1676185026862.png)

![](DataStructure2.assets/1676185410900.png)
...
- 串的链式存储
  ...
  ![](DataStructure2.assets/1676186240783.png)
...
- **算法4.1 BF 算法 Brute-Force**
  ...
  ![](DataStructure2.assets/1676197008295.png)

  ![](DataStructure2.assets/1676197145257.png)

  ![](DataStructure2.assets/1676197268414.png)

  总结一下:

  ![](DataStructure2.assets/1676197393444.png)
...
- **KMP算法**
  ...
  ![](DataStructure2.assets/1676200564477.png)
  ...
  - **子串怎么滑?**  
    ...
    ![](DataStructure2.assets/1676256061178.png)
    ...
    ![](DataStructure2.assets/1676256447679.png)
    ...
    ![](DataStructure2.assets/1676257388538.png)

    ![](DataStructure2.assets/1676257447715.png)

  > Max k的意思其实就是找到最长相等子串. t1与si不相等, 只能移动主串的指针.

  由此定义可推出模式串的next 函数值，如图4.6 所示。

  ![](DataStructure2.assets/1676257470928.png)
  ...
  ![](DataStructure2.assets/1676257799231.png)
  ...
  ![](DataStructure2.assets/1676258423629.png)
...
- 算法4.3 计算next函数值
  ...
  ![](DataStructure2.assets/1676259483620.png)
...
![](DataStructure2.assets/1676279582978.png)
...
![](DataStructure2.assets/1676281043807.png)

![](DataStructure2.assets/1676281843523.png)
...
![](DataStructure2.assets/1676282941146.png)
...
![](DataStructure2.assets/1676297780718.png)

![](DataStructure2.assets/1676297859259.png)

- 对称矩阵

  ![](DataStructure2.assets/1676297950047.png)

  ![](DataStructure2.assets/1676298510024.png)
...
- 三角矩阵
  ...
  ![](DataStructure2.assets/1676299355137.png)
...
- 对角矩阵
  ...
  ![](DataStructure2.assets/1676301328338.png)

在上述这些特殊矩阵中，非零元的分布都有一个明显的规律，从而可将其压缩存储到一维数组中，并找到每个非零元在一维数组中的对应关系。然而，在实际应用中还经常会遇到另一类矩阵，其非零元较零元少，且分布没有一定规律，称之为稀疏矩阵.

- 稀疏矩阵

  ![](DataStructure2.assets/1676383057960.png)

  三元组顺序表:

  ![](DataStructure2.assets/1676383131116.png)

  ![](DataStructure2.assets/1676383211954.png)

  链式存储结构: 十字链表:

  ![](DataStructure2.assets/1676383475197.png)

  ![](DataStructure2.assets/1676383866706.png)

  ![](DataStructure2.assets/1676383944089.png)
...
![](DataStructure2.assets/1676446453273.png)

广义表的定义是一个递归的定义，因为在描述广义表时又用到了广义表的概念。

![](DataStructure2.assets/1676446997867.png)

![](DataStructure2.assets/1676447427874.png)

广义表的性质:

- 广义表中的数据元素有相对次序, 一个直接前驱和一个直接后继.
- ![](DataStructure2.assets/1676447591057.png)

- ![](DataStructure2.assets/1676447669818.png)

- 广义表跟线性表的区别:
- ![](DataStructure2.assets/1676447732051.png)
...
- 广义表的基本运算:
  ...
  ![](DataStructure2.assets/1676448069573.png)
