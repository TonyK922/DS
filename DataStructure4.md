...
![](DataStructure4.assets/1677475108488.png)
图是一种比线性表和树更为复杂的数据结构。
...
![](DataStructure4.assets/1677484167382.png)
...
![](DataStructure4.assets/1677484424320.png)
...
![](DataStructure4.assets/1677489380661.png)

`有向树`: 有一个顶点的入度为0, 其余顶点的入度均为1的有向图称为有向树。
![](DataStructure4.assets/1677489454423.png)
...
![](DataStructure4.assets/1677491338131.png)
...
![](DataStructure4.assets/1677491902273.png)

`子图`:
![](DataStructure4.assets/1677492088334.png)

`连通分量`和`强连通分量`: 所谓连通分量, 指的是`无向图`中的极大连通子图. 有`向图中`的极大强连通子图称作有向图的强连通分量。
![](DataStructure4.assets/1677492260884.png)
![](DataStructure4.assets/1677492440999.png)
...
![](DataStructure4.assets/1677493380531.png)
...
![](DataStructure4.assets/1677505411573.png)

## 6.3 图的类型定义

图是一种数据结构，加上一组基本操作，就构成了抽象数据类型。抽象数据类型图的定义如下：
![](DataStructure4.assets/1677505676315.png)
...
![](DataStructure4.assets/1677506368545.png)
...
1. **邻接矩阵表示法**
   ...
   ![](DataStructure4.assets/1677506486125.png)

   ![](DataStructure4.assets/1677506729727.png)

   - **举个栗子:**

   ![](DataStructure4.assets/1677559486050.png)

   ![](DataStructure4.assets/1677571434395.png)
...
2. **网的邻接矩阵表示法**
   ...
   ![](DataStructure4.assets/1677571974759.png)
...
1. **邻接表表示法**
   ...
   ![](DataStructure4.assets/1677576231336.png)

   举例: 无向图

   ![](DataStructure4.assets/1677577196544.png)
   ...
   ![](DataStructure4.assets/1677578900180.png)
   ...
   ![](DataStructure4.assets/1677653799067.png)
...
2. **采用邻接表表示法创建无向图**
   ...
   */
   ...
   ![](DataStructure4.assets/1677656368539.png)

- **邻接矩阵与邻接表**

  ![](DataStructure4.assets/1677657002878.png)
...
![](DataStructure4.assets/1677659022354.png)
...
![](DataStructure4.assets/1677666333037.png)

邻接多重表的结构和十字链表类似. 在邻接多重表中, 每一条边用一个结点表示.

![](DataStructure4.assets/1677667004428.png)
...
![](DataStructure4.assets/1677667682570.png)
...
1. **深度优先搜索遍历的过程**
   ...
   ![](DataStructure4.assets/1677735304205.png)

   例子:

   ![](DataStructure4.assets/1677735869734.png)
   ![](DataStructure4.assets/1677736258586.png)
   ![](DataStructure4.assets/1677736862224.png)
   ...
   2. **深度优先搜索遍历的算法实现**
      ...
      **算法6.3 深度优先搜索遍历连通图**
      ...
      ![](DataStructure4.assets/1677747106143.png)
      ...
      **算法6.4 深度优先搜索遍历非连通图**
      ...
      ![](DataStructure4.assets/1677749878667.png)
...
1. 广度优先搜索遍历的过程
   ...
   ![](DataStructure4.assets/1677753180124.png)
...
2. 广度优先搜索遍历的算法实现
   ...
   **算法6.7 广度优先搜索遍历连通图**
   ...
   ![](DataStructure4.assets/1677754414283.png)
...
![](DataStructure4.assets/1677755857022.png)

> 含n个顶点, n-1条边的图不一定是生成树 , 因为不一定是连通图

- 无向图的生成树

![](DataStructure4.assets/1677756408929.png)

- 最小生成树

![](DataStructure4.assets/1677756988733.png)

> 必须是个连通图, 且网的权值是所有可能里最小的.

- 最小生成树的典型应用

![](DataStructure4.assets/1677757492539.png)

- 构造最小生成树 Minimum Spanning Tree

**MST性质:**

![](DataStructure4.assets/1677761867085.png)

MST性质解释:

![](DataStructure4.assets/1677761993833.png)

1. 普里姆算法 Prim

   - 算法思想:

   ![](DataStructure4.assets/1677767443362.png)
   ...
   ![](DataStructure4.assets/1677831730681.png)
   ...
   **算法6.8 普里姆算法**
   ...
   2. 克鲁斯卡尔算法 Kruskal
      ...
      ![](DataStructure4.assets/1677847152525.png)
